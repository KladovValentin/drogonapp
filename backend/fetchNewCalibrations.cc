...
int main(int argc, char* argv[]) {
    ...
    while(1){
        ...
        std::string launchScript = (string)("ssh -J vkladov@lxpool.gsi.de vkladov@vae25.hpc.gsi.de") +
                                    (string)(" 'cd /lustre/hades/user/vkladov/sub/testBatchFarm") +
                                    (string)(" . ./sendScript_raw_SL.sh " + day + "'");
        //std::system(launchScript.c_str());


        std::string checkSqueue = (string)("ssh -J vkladov@lxpool.gsi.de vkladov@vae25.hpc.gsi.de") +
        ...
        while (1){
            ...
            if (squeueOut.find("vkladov") != std::string::npos){
                ...
                std::string hadd = (string)("ssh -J vkladov@lxpool.gsi.de vkladov@vae25.hpc.gsi.de") +
