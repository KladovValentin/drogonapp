...
///  !!! LD_LIBRARY_PATH=/home/localadmin_jmesschendorp/lib/instantclient_23_5:$LD_LIBRARY_PATH
...
int main(int argc, char** argv) {
    ...
    //controllerBase->epicsManager->makeTableWithEpicsData("app", 509443403, 1e9);
    //controllerBase->epicsManager->makeTableWithEpicsData("new", 509443403, 1e9);
    //controllerBase->epicsManager->makeTableWithEpicsData("new", 443786163, 1e10);

    //cout << dateRunF::runToFileName(445326023) << endl;
    //cout << dateRunF::runToDate(445326023) << endl;
    //cout << dateRunF::runToDate(509362804) << endl;
    //cout << dateRunF::runToDate(544802886) << endl;

    //cout << dateRunF::getRunIdFromFileName("be2406208000401.hld") << endl;
    //cout << dateRunF::getRunIdFromFileName("be2205104002301.hld") << endl;

    //controllerBase->epicsManager->makeTableWithEpicsDataExtended("new", 443670000, 1e9,"MDCModSecPreciseExtended");
